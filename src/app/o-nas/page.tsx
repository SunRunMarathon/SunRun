        ...
        <section className="min-h-screen flex items-center px-8 sm:px-16 md:px-28 pt-24 pb-16">
          <div className="w-full grid lg:grid-cols-2 gap-10 xl:gap-16 items-center">
            <div className="max-w-3xl space-y-6">
              <span className="inline-block text-xs font-bold uppercase tracking-[0.25em] text-brand-blue px-3 py-1.5 bg-brand-blue/10 rounded-full border border-brand-blue/30">
                Kim jesteśmy
              </span>
              <h1 className="text-5xl sm:text-7xl font-black uppercase text-transparent bg-clip-text bg-gradient-to-br from-brand-blue via-brand-orange to-brand-red leading-none">
                O Nas
              </h1>
            ...
            <div className="hidden lg:block relative aspect-[4/3] rounded-3xl overflow-hidden border border-[#E2DBCC] shadow-2xl">
              <img
        ...
        <section className="py-12 px-8 sm:px-16 md:px-28">
          <div className="max-w-5xl mx-auto">
            <div className="bg-white/70 border border-[#E2DBCC] backdrop-blur-sm rounded-3xl p-8 sm:p-12 shadow-lg">
              ...
              <div className="grid sm:grid-cols-2 gap-8 text-sm text-[#3A342B] leading-relaxed">
                <p>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              {BRANCHES.map((b) => (
                <div
                  key={b.name}
                  className="bg-white/70 border border-[#E2DBCC] hover:border-[#D8CFBD] backdrop-blur-sm rounded-2xl p-6 transition-all duration-300 group shadow-sm"
                >
                  ...
                  <p className="text-sm text-[#6B6357] leading-relaxed">{b.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {TEAM.map((t) => (
                <div
                  key={t.name}
                  className="bg-white/70 border border-[#E2DBCC] backdrop-blur-sm rounded-2xl p-6 flex flex-col gap-3 shadow-sm"
                >
                  <div
                  ...
                  <div>
                    <p className="text-xs uppercase tracking-widest font-bold text-[#6B6357] mb-1">
                      {t.role}
                    </p>
            ...
            <p className="text-sm text-[#6B6357] mt-8 max-w-2xl">
